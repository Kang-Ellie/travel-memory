...
export function registerRoutes(app: ExpressApp): void {
  ...
  app.post('/api/places', async (req, res) => {
    const {
      ...
      valetCompany, bookingChannel, grade, directions, babyMenu, recommend, tip,
    } = req.body as {
    ...
    await pool.query(
      `INSERT INTO places (id, name, address, category, lat, lng, memo, map_url, rating, pros, cons, country_id, city_id,
         ...
         valet_company, booking_channel, grade, directions, baby_menu, recommend, tip)
  ...
  app.put('/api/places/:id', async (req, res) => {
    ...
    await pool.query(
      `UPDATE places SET name=$1, address=$2, category=$3, memo=$4, map_url=$5, rating=$6, pros=$7, cons=$8,
         ...
         valet_company=$15, booking_channel=$16, grade=$17, directions=$18, baby_menu=$19, recommend=$20, tip=$21 WHERE id=$22`,
